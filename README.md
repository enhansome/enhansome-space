...
* [SpaceXDB-Api](https://github.com/R4yGM/SpaceXDB-Api) ⭐ 36 | 🐛 0 | 🌐 JavaScript | 📅 2021-06-12 - [SpaceXDB](https://www.spacexdb.cf) is a website containing SpaceX launch information and telemetry.
...
* [Solar Wanderer](https://sw.icodestar.net) - A 1:1 real-time, browser-based solar system explorer using NASA JPL ephemerides. Seamless landing from orbit to walking on the surface, ray-marched atmospheres, and coverage out to the Oort Cloud. ([source](https://github.com/hyqzz/Solar-Wanderer) ⭐ 712 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-21)
* [ANISE](https://github.com/nyx-space/anise) ⭐ 266 | 🐛 35 | 🌐 Rust | 📅 2026-08-19 - ANISE provides a toolkit and files for Attitude, Navigation, Instrument, Spacecraft, and Ephemeris data. It's a modern replacement of the NAIF SPICE toolkit.
...
* [Rebound](https://github.com/hannorein/rebound) ⭐ 1,119 | 🐛 29 | 🌐 C | 📅 2026-08-18 - A multi-purpose N-body integrator
...
* [Awesome Space Autonomy](https://github.com/sylvesterkaczmarek/awesome-space-autonomy) ⭐ 0 | 🐛 0 | 📅 2026-08-17 - Curated research, flight demonstrations, software, tools, and guidance for autonomous spacecraft and space robots.
...
* [Launch Dashboard API](https://github.com/shahar603/Launch-Dashboard-API) ⭐ 117 | 🐛 11 | 🌐 JavaScript | 📅 2024-06-19 -  Open Source REST API for rocket launch telemetry
...
* [Open MCT](https://github.com/nasa/openmct) ⭐ 13,086 | 🐛 1,069 | 🌐 JavaScript | 📅 2026-08-20 - Ames's next-generation mission control framework for visualization of data on desktop and mobile devices.
...
* [SPICE](https://naif.jpl.nasa.gov/naif/toolkit.html) - Ephemerides library used by JPL for their missions. [SpiceyPy](https://github.com/AndrewAnnex/SpiceyPy) ⭐ 484 | 🐛 12 | 🌐 Python | 📅 2026-08-16 is a Python wrapper.
* [Nyx](https://github.com/nyx-space/nyx) ⭐ 479 | 🐛 25 | 🌐 Rust | 📅 2026-08-13 - Nyx is a high fidelity astrodynamics toolkit for mission design and orbit determination in Rust and Python, used on several lunar missions.
...
* [NOS3](https://github.com/nasa/nos3) ⭐ 612 | 🐛 70 | 🌐 C | 📅 2026-08-20 - NASA Operational Simulator for Small Satellites
* [Basilisk](https://github.com/AVSLab/basilisk) ⭐ 367 | 🐛 72 | 🌐 C | 📅 2026-08-20 - C/C++ astrodynamics and attitude control simulation (includes Python scripting).
* [Space Robotics Bench](https://github.com/AndrejOrsula/space_robotics_bench) ⭐ 182 | 🐛 18 | 🌐 Python | 📅 2025-12-01 - Simulation environments and tasks for developing and validating autonomous systems in orbital and planetary robotics scenarios.
* [Trick](https://github.com/nasa/trick) ⭐ 158 | 🐛 112 | 🌐 C++ | 📅 2026-08-19 - End-to-end physics simulation package, useful for simulating missions (but requires orbital dynamics models). C, C++, with Python (SWIG) interface.
...
* [libswiftnav](https://github.com/swift-nav/libswiftnav) ⭐ 23 | 🐛 3 | 🌐 Pawn | 📅 2025-11-24 and [libsbp](https://github.com/swift-nav/libsbp) ⭐ 76 | 🐛 7 | 🌐 C++ | 📅 2026-08-21 (Swift binary protocol for communicating with receiver hardware)

#### Radios

* [LFR transceiver](http://lfradio.space/) - Little Free Radio (LFR) is an open source, command, telemetry, and data radio for cubesats.
* OpenLST transceiver [hardware](https://github.com/OpenLST/openlst-hw) ⭐ 37 | 🐛 1 | 📅 2021-11-08 and [firmware](https://github.com/OpenLST/openlst) ⭐ 115 | 🐛 5 | 🌐 C | 📅 2023-12-04 - OpenLST is an open source, proven radio design for communicating with remote instruments, vehicles, and stations using low-cost commercial components. Based on Planet Labs' telemetry/command radio.

#### Star Trackers

* [MIT Tetra](https://github.com/brownj4/Tetra) ⭐ 50 | 🐛 1 | 🌐 C | 📅 2020-05-15 and its fork, [ESA Tetra](https://github.com/esa/tetra3) ⭐ 166 | 🐛 3 | 🌐 Python | 📅 2024-08-14 - Open source star tracker which relies more extensively on hashes for faster lookups
* [Oresat star tracker](https://github.com/oresat/oresat-star-tracker) ⭐ 47 | 🐛 8 | 🌐 Makefile | 📅 2026-08-06 - Open star tracker hardware [with software](https://github.com/oresat/oresat-star-tracker-software) ⭐ 25 | 🐛 14 | 🌐 Python | 📅 2026-08-09, based on UPNanosatLab's [openstartracker](https://github.com/UBNanosatLab/openstartracker) ⭐ 197 | 🐛 1 | 🌐 Python | 📅 2026-06-24 (which doesn't compile or have hardware)

### Spacecraft Software

* [JPL F Prime](https://github.com/nasa/fprime) ⭐ 11,679 | 🐛 442 | 🌐 C++ | 📅 2026-08-20 - F Prime (FÊ¹) is a component-driven framework that enables rapid development and deployment of spaceflight and other embedded software applications, originally developed at the Jet Propulsion Laboratory.
* [Core Flight System](https://github.com/nasa/cfs) ⭐ 1,461 | 🐛 107 | 🌐 C | 📅 2026-08-21 - NASA portable and extendable flight software framework with extensive flight heritage and a growing suite of applications and platform ports
* [FossaSat-1](https://fossa.systems/fossasat/) - Hardware designs and software for the FossaSat-1 Pocketqube satellite ([GitHub](https://github.com/Bambofy/FossaSat-1) ⭐ 561 | 🐛 10 | 🌐 HTML | 📅 2019-12-09)
* [SatCat5](https://github.com/the-aerospace-corporation/satcat5) ⭐ 507 | 🐛 1 | 🌐 VHDL | 📅 2026-08-13 - A mixed-media Ethernet switch for connecting smallsat payloads
* [OpenSatKit](https://github.com/OpenSatKit/OpenSatKit) ⭐ 298 | 🐛 64 | 🌐 C | 📅 2024-03-25 - A complete [Core Flight System](https://github.com/nasa/cfs) ⭐ 1,461 | 🐛 107 | 🌐 C | 📅 2026-08-21 training and application development environment that includes [COSMOS](https://cosmosrb.com/) and [42](https://software.nasa.gov/software/GSC-16720-1)
* [Space ROS](https://github.com/space-ros/space-ros) ⭐ 239 | 🐛 12 | 🌐 Earthly | 📅 2026-08-19 - ROS 2-based framework for space robotics software, testing, and interoperability.
* [NanoSat MO Framework](http://nanosat-mo-framework.github.io) - A software framework for nanosatellites based on the latest CCSDS standards. Developed by ESA and used in OPS-SAT mission ([GitHub](https://github.com/esa/nanosat-mo-framework) ⭐ 123 | 🐛 2 | 🌐 Java | 📅 2026-08-09)
...
* [Apollo 11 Guidance Code](https://github.com/chrislgarry/Apollo-11) ⭐ 72,139 | 🐛 131 | 🌐 Assembly | 📅 2026-07-15 - Original Apollo 11 Guidance Computer (AGC) source code for the command and lunar modules

### Tracking & Orbit Determination

* [satellite.js](https://github.com/shashwatak/satellite-js) ⭐ 1,078 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-20 - A library to make satellite propagation via TLEs possible on the web. Provides the functions necessary for SGP4/SDP4 calculations, as callable javascript. Also provides functions for coordinate transforms.
* [python-sgp4](https://github.com/brandon-rhodes/python-sgp4) ⭐ 469 | 🐛 8 | 🌐 Python | 📅 2026-07-12 - Python implementation of most recent version of the SGP4 satellite tracking algorithm
...
* [jspredict](https://github.com/nsat/jspredict) ⭐ 53 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-20 - A Javascript port of the popular predict satellite tracking library.
...
* [SIMPLETON](https://github.com/Salad109/SIMPLETON) ⭐ 2 | 🐛 1 | 🌐 Java | 📅 2026-08-17 - All-vs-all conjunction screener inspired by and validated against CelesTrak SOCRATES. Scans the entire catalog in under 30 seconds on consumer hardware.
