...
* [Open MCT](https://github.com/nasa/openmct) ⭐ 13,107 | 🐛 1,080 | 🌐 JavaScript | 📅 2026-08-26 - Ames's next-generation mission control framework for visualization of data on desktop and mobile devices.
...
* [NOS3](https://github.com/nasa/nos3) ⭐ 620 | 🐛 70 | 🌐 C | 📅 2026-08-21 - NASA Operational Simulator for Small Satellites
* [Basilisk](https://github.com/AVSLab/basilisk) ⭐ 375 | 🐛 52 | 🌐 C | 📅 2026-09-02 - C/C++ astrodynamics and attitude control simulation (includes Python scripting).
...
* [Trick](https://github.com/nasa/trick) ⭐ 160 | 🐛 112 | 🌐 C++ | 📅 2026-08-29 - End-to-end physics simulation package, useful for simulating missions (but requires orbital dynamics models). C, C++, with Python (SWIG) interface.
...
* [libswiftnav](https://github.com/swift-nav/libswiftnav) ⭐ 23 | 🐛 3 | 🌐 Pawn | 📅 2025-11-24 and [libsbp](https://github.com/swift-nav/libsbp) ⭐ 76 | 🐛 8 | 🌐 C++ | 📅 2026-08-31 (Swift binary protocol for communicating with receiver hardware)
...
* [JPL F Prime](https://github.com/nasa/fprime) ⭐ 11,721 | 🐛 457 | 🌐 C++ | 📅 2026-09-01 - F Prime (FÊ¹) is a component-driven framework that enables rapid development and deployment of spaceflight and other embedded software applications, originally developed at the Jet Propulsion Laboratory.
* [Core Flight System](https://github.com/nasa/cfs) ⭐ 1,479 | 🐛 109 | 🌐 C | 📅 2026-09-02 - NASA portable and extendable flight software framework with extensive flight heritage and a growing suite of applications and platform ports
* [FossaSat-1](https://fossa.systems/fossasat/) - Hardware designs and software for the FossaSat-1 Pocketqube satellite ([GitHub](https://github.com/Bambofy/FossaSat-1) ⭐ 561 | 🐛 10 | 🌐 HTML | 📅 2019-12-09)
...
* [OpenSatKit](https://github.com/OpenSatKit/OpenSatKit) ⭐ 299 | 🐛 64 | 🌐 C | 📅 2024-03-25 - A complete [Core Flight System](https://github.com/nasa/cfs) ⭐ 1,479 | 🐛 109 | 🌐 C | 📅 2026-09-02 training and application development environment that includes [COSMOS](https://cosmosrb.com/) and [42](https://software.nasa.gov/software/GSC-16720-1)
...
* [Apollo 11 Guidance Code](https://github.com/chrislgarry/Apollo-11) ⭐ 72,259 | 🐛 129 | 🌐 Assembly | 📅 2026-07-15 - Original Apollo 11 Guidance Computer (AGC) source code for the command and lunar modules

### Tracking & Orbit Determination

* [satellite.js](https://github.com/shashwatak/satellite-js) ⭐ 1,082 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-20 - A library to make satellite propagation via TLEs possible on the web. Provides the functions necessary for SGP4/SDP4 calculations, as callable javascript. Also provides functions for coordinate transforms.
...
* [jspredict](https://github.com/nsat/jspredict) ⭐ 53 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-02 - A Javascript port of the popular predict satellite tracking library.
...
* [SIMPLETON](https://github.com/Salad109/SIMPLETON) ⭐ 2 | 🐛 6 | 🌐 Java | 📅 2026-08-31 - All-vs-all conjunction screener inspired by and validated against CelesTrak SOCRATES. Scans the entire catalog in under 30 seconds on consumer hardware.
